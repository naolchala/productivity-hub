			...
			<div className="max-w-7xl mx-auto flex-1 space-y-10 p-6 md:p-10 pt-8">
					...
					<Card className="border-0 shadow-lg">
						...
						<CardContent>
							<div className="flex items-end gap-2">
								...
								<Badge
									variant="outline"
									className="text-xs text-emerald-500 border-emerald-200 bg-emerald-50 ml-2"
								>
					...
					<Card className="border-0 shadow-lg">
						...
						<CardContent>
							<div className="flex items-end gap-2">
								...
								<Badge
									variant="outline"
									className="text-xs text-purple-500 border-purple-200 bg-purple-50 ml-2"
								>
					...
					<Card className="border-0 shadow-lg">
						...
						<CardContent>
							<div className="flex items-end gap-2">
								...
								<Badge
									variant="outline"
									className="text-xs text-amber-500 border-amber-200 bg-amber-50 ml-2"
								>
				...
				<Card className="border-0 shadow-lg mt-8">
					<CardHeader className="pb-6">
						...
						<CardDescription>
							Frequently used actions across your productivity
							suite
						</CardDescription>
					</CardHeader>
					<CardContent className="pt-0">
